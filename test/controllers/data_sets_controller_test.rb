...
class DataSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_set" do
    assert_difference('DataSet.count') do
      post data_sets_url, params: { data_set: { data_ends: @data_set.data_ends, data_source_id: @data_set.data_source_id, data_starts: @data_set.data_starts, name: @data_set.name, production: @data_set.production } }
    end
  ...
  test "should update data_set" do
    patch data_set_url(@data_set), params: { data_set: { data_ends: @data_set.data_ends, data_source_id: @data_set.data_source_id, data_starts: @data_set.data_starts, name: @data_set.name, production: @data_set.production } }
