...
class DataSourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_source" do
    assert_difference('DataSource.count') do
      post data_sources_url, params: { data_source: { location: @data_source.location, name: @data_source.name, production: @data_source.production, refresh_frequency: @data_source.refresh_frequency, reliability: @data_source.reliability } }
    end
  ...
  test "should update data_source" do
    patch data_source_url(@data_source), params: { data_source: { location: @data_source.location, name: @data_source.name, production: @data_source.production, refresh_frequency: @data_source.refresh_frequency, reliability: @data_source.reliability } }
